...
|Name|Description|Link|
|-|-|-|
|Game Compatibility List (Yuzu)|"The compatibility list contains all the games that have been tested, sorted by how well they work on the emulator."|https://yuzu-emu.org/game/|
|***Switch-Emulators-Guide***|"A guide to get either Yuzu or Ryujinx running on your PC. Includes links for games, keys, firmware, shaders and some other stuff." (Most, if not all, of the switch piracy information on this page comes from here)|https://github.com/Abd-007/Switch-Emulators-Guide/blob/main/Links.md|
|SwitchPirates|"Get information on everything revolving around piracy on the Nintendo Switch from apps, games, development, and support."|https://www.reddit.com/r/SwitchPirates/|
|NewYuzuPiracy|"Here you can find everything related to the switch emulator Yuzu." (A reboot of r/YuzuPiracy that was banned)|https://www.reddit.com/r/NewYuzuPiracy/|

## Keys

|Name|Description|Link|
|-|-|-|
|||https://drive.google.com/drive/folders/1KAym-RpGIDuJiSmMLmpCtGVbhLm4VjTZ?usp=sharing|
